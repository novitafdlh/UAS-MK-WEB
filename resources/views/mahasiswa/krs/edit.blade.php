            ...
            <div class="p-6">
                ...
                <div class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
                    <div class="flex items-center">
                        ...
                        <div>
                            <span class="text-blue-800 font-medium">Mata kuliah saat ini: </span>
                            <span class="text-blue-700">{{ $krs->mataKuliah->kode }} - {{ $krs->mataKuliah->nama }} ({{ $krs->mataKuliah->sks }} SKS)</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <select name="mata_kuliah_id" id="mata_kuliah_id" required
                                class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200 appearance-none bg-white">
