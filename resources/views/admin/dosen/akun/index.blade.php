...
<div class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Daftar Akun Dosen</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-red-100 text-red-900">
                <tr>
                    ...
                    <th class="w-36 px-3 py-3 text-center text-xs font-semibold uppercase whitespace-nowrap">Aksi</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                <tr class="hover:bg-red-50 transition">
                    ...
                    <td class="px-5 py-3 text-sm text-gray-800">{{ $user->role ?? 'Dosen' }}</td>
                    <td class="w-36 px-3 py-3 text-sm text-center whitespace-nowrap">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            {{-- Tombol Hapus --}}
                            <form action="{{ route('admin.dosen.akun.destroy', $user->id) }}" method="POST"
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-5 py-6 text-center text-gray-500 italic">😕 Belum ada akun dosen.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
