...
<main class="flex-1 p-4 md:p-6 bg-gradient-to-br from-white to-white min-h-screen">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-black-600">Buat akun mahasiswa baru untuk sistem</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.mahasiswa.akun.index') }}" 
                   class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-400 to-red-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-gray-600 hover:to-gray-700 transform hover:-translate-y-0.5 transition-all duration-200">
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-red-100 rounded-2xl shadow-sm border border-rose-100 overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ route('admin.mahasiswa.akun.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all duration-200 @error('name') border-red-300 @enderror">
                        </div>
                        @error('name') 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="role" 
                                    id="role"
                                    required
                                    class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all duration-200 appearance-none bg-white @error('role') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" 
                                   ...
                                   required
                                   class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-500 focus:border-transparent transition-all duration-200">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" 
                                class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-red-300 to-red-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-red-300 hover:to-red-700 transform hover:-translate-y-0.5 transition-all duration-200">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            Simpan Akun
