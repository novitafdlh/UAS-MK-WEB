...
<main class="flex-1 p-4 md:p-6 bg-gradient-to-br from-rose-50 to-red-50 min-h-screen">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-red-600 to-red-300 bg-clip-text text-transparent mb-2">
                    Edit Mahasiswa
                </h1>
                <p class="text-black">Perbarui informasi data mahasiswa</p>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h4 class="text-blue-800 font-semibold">{{ $mahasiswa->nama }}</h4>
                            <p class="text-blue-600 text-sm">NIM: {{ $mahasiswa->nim }} | Email: {{ $mahasiswa->email }}</p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('admin.mahasiswa.data.update', $mahasiswa->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" 
                                class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-red-500 to-red-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-orange-600 transform hover:-translate-y-0.5 transition-all duration-200">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
