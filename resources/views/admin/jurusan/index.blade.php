...
<main class="flex-1 p-4 md:p-6 bg-gradient-to-br from-red-200 to-red-300 min-h-screen">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-rose-500 font-medium">Kelola data jurusan universitas</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="group relative bg-white rounded-2xl shadow-sm border border-rose-100 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-2">Total Jurusan</h3>
            <p class="text-3xl font-bold text-rose-600 mb-1">{{ $jurusans->count() }}</p>
