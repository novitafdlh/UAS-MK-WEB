...
<main class="flex-1 p-4 md:p-6 bg-gradient-to-br from-dark-blue-50 to-gray-50 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-dark-blue-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-red-accent-50 to-red-accent-100">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-red-accent-400 to-red-accent-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                        1
                    </div>
                    ...
                    <div>
                        <label for="prodi_id" class="block text-sm font-semibold text-gray-700 mb-3">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-dark-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div>
        ...
        <div class="relative">
            ...
            <select name="mahasiswa_id" id="mahasiswa_id" class="w-full pl-10 pr-4 py-3 border border-dark-blue-200 rounded-xl focus:ring-2 focus:ring-dark-blue-500 focus:border-transparent transition-all duration-200 appearance-none bg-white" onchange="this.form.submit()">
    ...
    @endif
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-dark-blue-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-dark-blue-50 to-red-accent-50">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-dark-blue-500 to-red-accent-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                        2
                    </div>
                    Input Nilai
                </h3>
            ...
            <div class="p-6">
                ...
                <div class="mb-6 p-4 bg-gradient-to-r from-dark-blue-50 to-red-accent-50 border border-dark-blue-200 rounded-xl">
                    ...
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gradient-to-br from-dark-blue-400 to-red-accent-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                            {{ substr($selectedMhs->name ?? 'M', 0, 2) }}
                        </div>
                        <div>
                            <h4 class="text-dark-blue-800 font-semibold">{{ $selectedMhs->name ?? '-' }}</h4>
                            <p class="text-dark-blue-600 text-sm">NIM: {{ $selectedMhs->nim ?? '-' }}</p>
                            <p class="text-dark-blue-600 text-sm">Mata Kuliah: {{ $selectedMk->nama ?? '-' }} ({{ $selectedMk->sks ?? '0' }} SKS)</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text"
                                   ...
                                   class="w-full pl-10 pr-4 py-3 border border-dark-blue-200 rounded-xl focus:ring-2 focus:ring-dark-blue-500 focus:border-transparent transition-all duration-200"
                                   required>
                        </div>
