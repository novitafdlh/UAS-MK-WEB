...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex min-h-screen">
            ...
            <div>
                ...
                <nav class="mt-6 space-y-2 px-4">
                    <a href="{{ route('mahasiswa.dashboard') }}"
                       class="block px-3 py-2 rounded hover:bg-red-700 transition {{ request()->routeIs('mahasiswa.dashboard') ? 'bg-red-600' : '' }}">
                        🏠 Dashboard
                    </a>
        ...
        <main class="flex-1 p-6">
            ...
            {{-- Page Title --}}
            <h2 class="text-xl font-semibold text-red-700 mb-6">Dashboard Mahasiswa</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div class="bg-indigo-100 p-5 rounded-xl shadow hover:shadow-lg transition">
                    ...
                    <p class="text-4xl font-bold text-indigo-900 mt-2">37,964</p>
                </div>
                ...
                <div class="bg-yellow-100 p-5 rounded-xl shadow hover:shadow-lg transition">
                    ...
                    <p class="text-4xl font-bold text-yellow-900 mt-2">1,139</p>
                </div>
            </div>

            {{-- Visi & Misi UNTAD --}}
            <div class="p-6 rounded-xl shadow-md bg-red-800 mb-6 text-white">
                <h2 class="text-2xl font-bold mb-4 text-center">Visi & Misi Universitas Tadulako</h2>

                {{-- Visi --}}
                <div class="mb-6">
                    <h3 class="text-xl font-semibold mb-2">🎯 Visi</h3>
                    <p class="italic border-l-4 border-red-500 pl-4">
